...
final class ScheduleViewController: UIViewController {
    ...
    private lazy var confirmButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("CreateCategoryViewController.button", comment: "Ready"), for: .normal)
...
private extension ScheduleViewController {
    func configureViews() {
        title = NSLocalizedString("TypeTrackerViewController.parameter2", comment: "Schedule")
...
extension ScheduleViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let weekdayCell = tableView.dequeueReusableCell(
            withIdentifier: WeekdayCell.identifier) as? WeekdayCell else { return UITableViewCell() }
